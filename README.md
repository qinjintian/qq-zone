...
<p align="center">
  <img src="docs/images/demo.png" alt="终端扫码登录并勾选相册" width="920">
</p>

<p align="center"><sub>终端里扫码登录、勾选相册。说说走同一套菜单，备份完成后会生成可双击打开的时间线网页。</sub></p>
...
QQ 空间里堆着很多人的照片、视频和说说。手动保存又慢，相册还经常变成压缩图，说说更是只能在网页里翻。本工具用 **Go** 重写：相册支持 **原图 / 原视频 / 实况图** 并 **保留拍摄信息（EXIF）**；说说会连同配图、视频、评论、点赞和浏览数一起拉下来，并生成一份 **可双击打开的本地时间线网页**。手机 QQ **扫码登录** 即可，不用复制 Cookie。

自己的空间和好友对你开放的空间都可以备份。已有文件会跳过，隔几个月再跑一遍只补新的。
